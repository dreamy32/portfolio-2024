          ...
          <BlurFade delay={BLUR_FADE_DELAY * 13}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                  I volunteer in various fields
                </h2>
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Here are some of the volunteering activities I have been involved in.
                </p>
              </div>
            </div>
          </BlurFade>
          <BlurFade delay={BLUR_FADE_DELAY * 14}>
            <ul className="relative divide-y divide-dashed"> {/* Use divide utility instead */}
              {DATA.volunteering.map((volunteer, id) => (
                <BlurFade
                  key={volunteer.title + volunteer.dates}
                  delay={BLUR_FADE_DELAY * 15 + id * 0.05}
                >
                  <div className="py-0"> {/* Add consistent padding */}
                    <VolunteerCard
